                            ...
                            <div class="ifind-business-item <?php echo $list_category_filter; ?>">
                                <div class="ifind-business-logo">
                                    ...
                                    <a class="ifind-counter-item fancybox fancybox.iframe <?php echo $fancybox_class; ?> business-logo-link" 
                                        ...
                                        <?php if ($business_info_banner_type === 'content-file-and-video') { ?>
                                            <div class="ifind-content-file-and-video-wrap" id="ifind-content-file-and-video-<?php echo $business_id; ?>">
                                                <div class="ifind-content-file-and-video-content">
                                                    <?php if ($business_info_file) { ?>
                                                        <div class="ifind-content-file-and-video-banner">
                                                            <iframe src="<?php echo $business_info_file; ?>" class="fancybox-iframe" frameborder="0" vspace="0" hspace="0" webkitallowfullscreen="" mozallowfullscreen="" allowfullscreen="" scrolling="no"></iframe>
                                                        </div>
                                                    <?php } ?>
                                                    <div class="ifind-content-file-and-video-video">
                                                        <!-- Video files -->
                                                        <video id="ifind-video-player-<?php echo $business_id; ?>" controller crossorigin playsinline muted>
                                                            <source type="video/mp4" size="1280">
                                                        </video>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="ifind-business-direction">
                                    <a href="#" class="ifind-counter-item business-direction-link" 
                                        ...
                                        <img class="ifind-business-icon" src="<?php echo WD_THEME_IMAGES.'/directions.png'; ?>">
                                ...
                                <div class="ifind-business-geocoding">
                                    <a href="#" class="ifind-counter-item business-geocoding-link" 
                                        ...
                                        <img class="ifind-business-icon" src="<?php echo WD_THEME_IMAGES.'/marker.png'; ?>">
                                ...
                                <div class="ifind-business-contact">
                                    <a class="ifind-counter-item fancybox-contact-us" 
                                        ...
                                        <img class="ifind-business-icon" src="<?php echo WD_THEME_IMAGES.'/contact.png'; ?>">
                                ...
                                <!-- <div class="ifind-business-qrcode">
                                    <a class="fancybox fancybox.iframe ifind-fancybox-image" href="<?php //echo $qr_link; ?>">
                                        ...
                                        <img class="ifind-business-icon" src="<?php //echo WD_THEME_IMAGES.'/qrcode.png'; ?>">
