...
<div class="ifind-list-business">
    ...
    require_once WD_THEME_DIR."/sections/tabs/banner-image.php";
    require_once WD_THEME_DIR."/sections/tabs/send-mail-form.php"; ?>
    
    <div id="ifind-business-tabs" class="wow fadeInUp" data-wow-duration="2s">	
        <div class="ifind-business-tabs-wrap">
            <?php 
            require_once WD_THEME_DIR."/sections/tabs/back-link.php";
            require_once WD_THEME_DIR."/sections/tabs/map-directions.php";
            require_once WD_THEME_DIR."/sections/tabs/tab-nav.php";
            require_once WD_THEME_DIR."/sections/tabs/tab-content.php";
            require_once WD_THEME_DIR."/sections/tabs/iframes.php";
            require_once WD_THEME_DIR."/sections/tabs/contact-form.php";
            ?>
    </div>
</div>
